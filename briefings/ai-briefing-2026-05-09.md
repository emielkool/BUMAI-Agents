...
*(Bron: [VentureBeat – Prompt injection measurable metric](https://venturebeat.com/security/prompt-injection-measurable-security-metric-one-ai-developer-publishes-numbers))*
